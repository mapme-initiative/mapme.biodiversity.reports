...
wdpa_kfw <- read_sf("../data/shared/portfolio.gpkg")
...
if (file.exists("../data/bolivia/output/bolivia_forest_loss_2000_2024.csv")) {
...
if (file.exists("../data/bolivia/output/bolivia_burned_area_total_2015_2023.csv")) {
  burned_area_data <- read_csv(
    "../data/bolivia/output/bolivia_burned_area_total_2015_2023.csv",
    show_col_types = FALSE
  )
...
admin1 <- read_sf("../data/bolivia/input/admin1_subset.geojson", quiet = TRUE)
municipalities <- read_sf("../data/bolivia/input/municipalities.geojson", quiet = TRUE)
...
if (file.exists("../data/bolivia/output/bolivia_burned_area_annual_2015_2023.csv")) {
  burned_annual <- read_csv(
    "../data/bolivia/output/bolivia_burned_area_annual_2015_2023.csv",
    show_col_types = FALSE
  )
