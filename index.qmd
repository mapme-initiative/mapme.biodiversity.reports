...
<div class="hero-section">
  <div class="hero-content">
    ...
    <p class="hero-subtitle">Open-source geospatial analysis for conservation monitoring</p>
  </div>
</div>
```
...
Additional reports for other regions are in development:

- Central America portfolio analysis
- Ecuador mangrove assessment
- Selva Maya cross-border analysis
...
This project is part of the **MAPME Initiative** (Measuring and Advancing the Protection of Ecosystems), supporting KfW and partners in monitoring and evaluating conservation projects worldwide.
